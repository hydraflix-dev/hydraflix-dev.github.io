...
$.getJSON("http://alloworigin.com/get?url=https://yts.ag/api/v2/list_movies.json?query_term="+search_parameter, function (data) { // http://crossorigin.me/https://yts.ag/api/v2/list_movies.json?query_term="+search_parameter, function (data) {
	$('#movies').html("");
