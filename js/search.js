...
$.getJSON("http://alloworigin.com/get?url=http://yify.is/index.php/api/v2/list_movies.json?query_term="+search_parameter, function (data) { // http://crossorigin.me/https://yts.ag/api/v2/list_movies.json?query_term="+search_parameter, function (data) {
	$('#movies').html("");
	...
	console.log("data.contents.data "+data.contents.data);
	json_data = data.contents.data.data.movies;
